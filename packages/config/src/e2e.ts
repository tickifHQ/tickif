...
export function buildE2eEnvironment(environment: NodeJS.ProcessEnv) {
  ...
  return {
    ...
    RAZORPAY_KEY_ID: 'rzp_test_tickif_e2e',
    RAZORPAY_KEY_SECRET: 'tickif-e2e-secret',
    RAZORPAY_WEBHOOK_SECRET: 'tickif-e2e-webhook',
    RAZORPAY_PLAN_ID_PROFESSIONAL_PLUS: 'plan_e2e_professional',
    RAZORPAY_PLAN_ID_CORPORATE: 'plan_e2e_corporate',
