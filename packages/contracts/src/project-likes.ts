...
export const projectLikeParamSchema = z
  .object({ projectId: z.uuid() })
  .meta({ id: 'ProjectLikeParam' });

export const projectLikesStateQuerySchema = z
  .object({
...
export const projectLikeStateSchema = z
  .object({
    projectId: z.uuid(),
...
export const projectLikesStateResponseSchema = z
  .object({
