...
ALTER TABLE "project_image" ADD CONSTRAINT "project_image_room_id_project_room_id_fk" FOREIGN KEY ("room_id") REFERENCES "public"."project_room"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "project_image_room_idx" ON "project_image" USING btree ("room_id");