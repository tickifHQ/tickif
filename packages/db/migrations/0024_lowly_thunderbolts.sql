ALTER TABLE "project" ADD COLUMN "moderation_revision" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
...
ALTER TABLE "project_image" ADD COLUMN "duplicate_checked_at" timestamp;--> statement-breakpoint
