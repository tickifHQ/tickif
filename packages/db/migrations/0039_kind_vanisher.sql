...
CREATE TABLE "payment_transaction" (
	...
	CONSTRAINT "payment_transaction_amount_positive" CHECK ("payment_transaction"."amount" > 0)
);
...
--> statement-breakpoint
ALTER TABLE "payment_transaction" ADD CONSTRAINT "payment_transaction_subscription_id_subscription_id_fk" FOREIGN KEY ("subscription_id") REFERENCES "public"."subscription"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "subscription_state_idx" ON "subscription" USING btree ("subscription_state");