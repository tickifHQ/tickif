...
ALTER TABLE "project_moderation_event" ADD CONSTRAINT "project_moderation_event_actor_user_id_user_id_fk" FOREIGN KEY ("actor_user_id") REFERENCES "public"."user"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
