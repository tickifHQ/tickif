...
-- 1. Recreate enum with all 13 values (E-29 base 8 + E-124 attribute kinds).
...
CREATE TYPE "public"."taxonomy_kind" AS ENUM('city','locality','property_type','bhk','room','scope','theme','budget_band','material','finish','layout','palette','size_band');--> statement-breakpoint
