...
ALTER TABLE "ownership_transfer_audit_event" ADD CONSTRAINT "ownership_transfer_audit_event_actor_user_id_user_id_fk" FOREIGN KEY ("actor_user_id") REFERENCES "public"."user"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ownership_transfer_request" ADD CONSTRAINT "ownership_transfer_request_initiator_user_id_user_id_fk" FOREIGN KEY ("initiator_user_id") REFERENCES "public"."user"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ownership_transfer_request" ADD CONSTRAINT "ownership_transfer_request_target_user_id_user_id_fk" FOREIGN KEY ("target_user_id") REFERENCES "public"."user"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
SET "role" = 'admin'
FROM ranked_owners
WHERE "member"."id" = ranked_owners."id" AND ranked_owners."rank" > 1;--> statement-breakpoint
