...
describe('DesignerProjectUpload', () => {
  beforeEach(() => {
    ...
    const taxonomyByKind = {
      city: [
        { id: 'city-1', label: 'Chennai', slug: 'chennai', parentId: null },
      ],
      property_type: [
        { id: 'type-1', label: 'Residential', slug: 'residential', parentId: null },
      ],
      property_subtype: [
        { id: 'subtype-1', label: 'Apartment', slug: 'apartment', parentId: null },
      ],
      bhk: [
        { id: 'bhk-1', label: '2 BHK', slug: '2-bhk', parentId: null },
      ],
      room: [
        {
      ...
      scope: [
        { id: 'scope-1', label: 'Construction', slug: 'construction', parentId: null },
      ],
      theme: [
        { id: 'theme-1', label: 'Modern', slug: 'modern', parentId: null },
      ],
      finish: [
        { id: 'finish-1', label: 'Matte', slug: 'matte', parentId: null },
      ],
      budget_band: [
        { id: 'budget-1', label: '20L-30L', slug: '20l-30l', parentId: null },
      ],
      locality: [
        { id: 'locality-1', label: 'Adyar', slug: 'adyar', parentId: 'city-1' },
      ],
    } as const;
