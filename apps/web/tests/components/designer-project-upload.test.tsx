...
describe('DesignerProjectUpload', () => {
  beforeEach(() => {
    ...
    const taxonomyByKind = {
      city: [
        { id: '11111111-1111-4111-8111-111111111101', label: 'Chennai', slug: 'chennai', parentId: null },
      ],
      property_type: [
        { id: '11111111-1111-4111-8111-111111111102', label: 'Residential', slug: 'residential', parentId: null },
      ],
      property_subtype: [
        { id: '11111111-1111-4111-8111-111111111103', label: 'Apartment', slug: 'apartment', parentId: null },
      ],
      bhk: [
        { id: '11111111-1111-4111-8111-111111111104', label: '2 BHK', slug: '2-bhk', parentId: null },
      ],
      room: [
        {
      ...
      scope: [
        { id: '11111111-1111-4111-8111-111111111105', label: 'Construction', slug: 'construction', parentId: null },
      ],
      theme: [
        { id: '11111111-1111-4111-8111-111111111106', label: 'Modern', slug: 'modern', parentId: null },
      ],
      finish: [
        { id: '11111111-1111-4111-8111-111111111107', label: 'Matte', slug: 'matte', parentId: null },
      ],
      budget_band: [
        { id: '11111111-1111-4111-8111-111111111108', label: '20L-30L', slug: '20l-30l', parentId: null },
      ],
      locality: [
        {
    ...
    mock.taxonomyGet.mockImplementation(async ({ query }: { query: { kind: keyof typeof taxonomyByKind } }) => ({
      ok: true,
  ...
  it('keeps a deleted image removed when the follow-up refresh fails', async () => {
    ...
    expect(screen.getByText(/image removed, but we could not refresh the latest processing status/i)).toBeInTheDocument();
  });
  ...
  it('unmounts room content when Project images is collapsed', async () => {
    ...
    const projectImagesToggle = screen.getByRole('button', { name: /step 4 project images/i });
    expect(screen.queryByText(/add new room type/i)).not.toBeInTheDocument();

    await user.click(projectImagesToggle);
    expect(await screen.findByText(/add new room type/i)).toBeInTheDocument();
