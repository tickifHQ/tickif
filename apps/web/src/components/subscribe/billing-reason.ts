export function reasonLabel(reason: string | null) {
  switch (reason) {
    ...
    case 'reconciliation_pending':
      return 'We are checking your billing change. Refresh billing before trying again.';
    ...
    default:
      return 'This change is not available yet. Refresh billing or contact support.';
  }
}
